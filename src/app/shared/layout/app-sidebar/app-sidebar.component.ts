...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    },
    {
      ...
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M8 2C8.41421 2 8.75 2.33579 8.75 2.75V3.75H15.25V2.75C15.25 2.33579 15.5858 2 16 2C16.4142 2 16.75 2.33579 16.75 2.75V3.75H18.5C19.7426 3.75 20.75 4.75736 20.75 6V9V19C20.75 20.2426 19.7426 21.25 18.5 21.25H5.5C4.25736 21.25 3.25 20.2426 3.25 19V9V6C3.25 4.75736 4.25736 3.75 5.5 3.75H7.25V2.75C7.25 2.33579 7.58579 2 8 2ZM8 5.25H5.5C5.08579 5.25 4.75 5.58579 4.75 6V8.25H19.25V6C19.25 5.58579 18.9142 5.25 18.5 5.25H16H8ZM19.25 9.75H4.75V19C4.75 19.4142 5.08579 19.75 5.5 19.75H18.5C18.9142 19.75 19.25 19.4142 19.25 19V9.75Z" fill="currentColor"></path></svg>`,
      subItems: [
        {name: "Calendario", path: "/calendario", pro: false}
      ]
    },
    {
    ...
    },
    {
      name: "Clientes",
      path: "/clientes",
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="9" cy="7.5" r="3.25" stroke="currentColor" stroke-width="1.5"></circle><path d="M3.75 19.75C3.75 16.8505 6.1005 14.5 9 14.5C11.8995 14.5 14.25 16.8505 14.25 19.75" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path><path d="M15 4.5C16.7949 4.5 18.25 5.95507 18.25 7.75C18.25 9.54493 16.7949 11 15 11" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path><path d="M15.5 14.75C18.2475 14.75 20.25 16.7525 20.25 19.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path></svg>`,
    },
    {
      name: "Mascotas",
      path: "/mascotas",
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7.25 10.25C6.15 10.25 5.25 9.35 5.25 8.25C5.25 7.15 6.15 6.25 7.25 6.25C8.35 6.25 9.25 7.15 9.25 8.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path><path d="M16.75 10.25C15.65 10.25 14.75 9.35 14.75 8.25C14.75 7.15 15.65 6.25 16.75 6.25C17.85 6.25 18.75 7.15 18.75 8.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path><path d="M12 20.5C8.55 20.5 6 18.35 6 15.35C6 12.45 8.55 10.5 12 10.5C15.45 10.5 18 12.45 18 15.35C18 18.35 15.45 20.5 12 20.5Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"></path><path d="M9.5 15.25H9.51M14.5 15.25H14.51M10.25 17.5C11.2 18.15 12.8 18.15 13.75 17.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path></svg>`,
    },
    {
      name: "Servicios",
      path: "/servicios",
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.75 3.75H8.5C7.39543 3.75 6.5 4.64543 6.5 5.75V19.25C6.5 20.3546 7.39543 21.25 8.5 21.25H17.5C18.6046 21.25 19.5 20.3546 19.5 19.25V5.75C19.5 4.64543 18.6046 3.75 17.5 3.75H16.25" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path><path d="M9.75 3.75C9.75 2.92157 10.4216 2.25 11.25 2.25H14.75C15.5784 2.25 16.25 2.92157 16.25 3.75V5.25H9.75V3.75Z" stroke="currentColor" stroke-width="1.5"></path><path d="M10 10H16M10 14H16M10 18H13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path></svg>`,
    },
    {
      name: "Empleados",
      path: "/empleados",
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16 20.5V19.5C16 17.8431 14.6569 16.5 13 16.5H6C4.34315 16.5 3 17.8431 3 19.5V20.5M12.5 8.5C12.5 10.433 10.933 12 9 12C7.067 12 5.5 10.433 5.5 8.5C5.5 6.567 7.067 5 9 5C10.933 5 12.5 6.567 12.5 8.5ZM15 5.5H21M15 9H21M15 12.5H19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>`,
    },
    {
      name: "Forms",
